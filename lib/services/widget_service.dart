...
class WidgetService {
  ...
  static Future<void> updateLogoutState() async {
    ...
    await HomeWidget.saveWidgetData('userRole', 'none');
    await HomeWidget.saveWidgetData('cwTotal', '₩ 0');
    await HomeWidget.saveWidgetData('dkTotal', '₩ 0');
    await HomeWidget.saveWidgetData('cwInterest', '₩ 0');
    await HomeWidget.saveWidgetData('dkInterest', '₩ 0');
    await HomeWidget.saveWidgetData('pendingCount', 0);
  ...
  static Future<void> updateWidgetData({
    ...
    await HomeWidget.saveWidgetData('cwInterest', _formatNum(cwInterest));
    await HomeWidget.saveWidgetData('dkTotal', _formatNum(dkTotal));
    await HomeWidget.saveWidgetData('dkInterest', _formatNum(dkInterest));
